          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_TapButton2.default, {
                ...
                color: this.props.color,
                onClick: function onClick() {
                  return _this2.props.store.sendSms(_this2.props.schedule_for, _this2.props.source, 1, '');
                }
              })
            ),
            _react2.default.createElement(
          ...
          window.location.href.indexOf('download=true') > -1 ? _react2.default.createElement(_TapButton2.default, {
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_TapButton2.default, {
                ...
                hoverStyle: true,
                onClick: function onClick() {
                  return _this2.props.store.sendSms(_this2.props.schedule_for, _this2.props.source, 0, _this2.getLink(_this2.props.link));
                }
              }),
              _react2.default.createElement(
                'p',
...
var CallToActionStore = function () {
  ...
  _createClass(CallToActionStore, [{
    ...
    key: 'sendSms',
    value: function sendSms(schedule_for, source, send_sms, redirectLink) {
      ...
      // console.log('this_.currentCountry.country_code '+this_.currentCountry.country_code);
        ...
        if (mypostrequest.readyState === 4) {
          if (mypostrequest.status === 200 || window.location.href.indexOf("http") === -1) {
            if (JSON.parse(mypostrequest.responseText).is_valid) {
              ...
              postrequest.send('mobile_number=' + this_.currentCountry.international_code + this_.mobile_number + '&source=' + source + '&country_code=' + this_.currentCountry.country_code + '&schedule_for=' + schedule_for + '&language_code=' + this_.language + '&send_sms=' + send_sms + '&add_lead=' + 1);
...
var ProductPage = function (_Component) {
  ...
  _createClass(ProductPage, [{
    ...
    value: function render() {
      ...
      var parameter = this.props.partner ? this.props.partner : '';
      this.props.preferencesStore.pageUrlKeys.src && this.props.preferencesStore.pageUrlKeys.src !== 'partner' && this.props.partner ? parameter = this.props.preferencesStore.pageUrlKeys.src : null;
...
module.exports = [{"product":"collect","title":{"en":"Our Community","ar":"مجتمعنا"},"testimonials":[{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/qoutmarket.jpg","qoute":{"en":"Tap has made our lives easier! From the great around the clock customer service to creating products that fit our sometimes unconventional needs.","ar":"تاپ جعلت حياتنا أسهل! خدمة على مدار الساعة لتقديم منتجات توائم احتياجاتنا الغير تقليدية"},"name":{"en":"Noaf & Budour","ar":"نوف وبدور"},"role":{"en":"Founders","ar":"مؤسسين"},"businessName":{"en":"Qout Market","ar":"قوت ماركت"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/yalwa.jpg","qoute":{"en":"Perfect payment solutions for our brides are just a click away!","ar":"حل الدفع الأمثل لعروساتنا على بعد ضغطة واحدة! "},"name":{"en":"Aroob Al Abdaly","ar":"عروب العبدلي"},"role":{"en":"Managing Partner","ar":"شريك إداري"},"businessName":{"en":"Yalwah","ar":"يلوه"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/niu.jpg","qoute":{"en":"We admire Tap’s dedication to start-ups & their great customer service.","ar":"نحن نحب إخلاص تاپ للشركات الناشئة وخدمة الزبائن الرائعة التي يقدمونها"},"name":{"en":"Haytham Al-Hawaj","ar":"هيثم الحواج"},"role":{"en":"Founder","ar":"مؤسس"},"businessName":{"en":"NIU","ar":"نيو"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/proteges.jpg","qoute":{"en":"Tap provided one of the best customer service experience I have come across in Kuwait.","ar":"تاپ قد وفر أفضل تجربة خدمة زبائن قد رأيتها في الكويت!"},"name":{"en":"Ahmad Salamah","ar":"إيمان الرشيد"},"role":{"en":"Deputy General Manager","ar":"نائب المدير العام"},"businessName":{"en":"The Proteges","ar":"ذا بروتيجز"}}]},{"product":"sell","title":{"en":"Our Community","ar":"مجتمعنا"},"testimonials":[{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/bilbayt.jpg","qoute":{"en":"Tap has truly enabled Bilbayt.com to serve it’s customer base effectively while also delivering the excellent user experience and interface we were searching for.","ar":"ا ب ت"},"name":{"en":"Ahmad Salamah","ar":"ا ب ت"},"role":{"en":"Co-founder & CEO","ar":"ا ب ت"},"businessName":{"en":"Bilbayt.com","ar":"ا ب ت"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/nuqat.jpg","qoute":{"en":"Tap has untapped the potential of our website through a well streamlined payment process!","ar":"ا ب ت"},"name":{"en":"Hussa Al Humaidhi","ar":"ا ب ت"},"role":{"en":"Founding Member","ar":"ا ب ت"},"businessName":{"en":"Nuqat","ar":"ا ب ت"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/opensouq.jpg","qoute":{"en":"We at OpenSooq.com are very happy with Tap, it proved to be a very reliable payment partner for us and our users love it!","ar":"ا ب ت"},"name":{"en":"Anas Elayyan","ar":"ا ب ت"},"role":{"en":"Head of Business Development","ar":"ا ب ت"},"businessName":{"en":"OpenSooq.com","ar":"ا ب ت"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/sirdablab.jpg","qoute":{"en":"Tap made it easy for us to set up a payment portal and accept payments quickly. It’s a wonderful service for budding businesses.","ar":"ا ب ت"},"name":{"en":"Haider Al Mosawi","ar":"ا ب ت"},"role":{"en":"Learning & Laughter Officer","ar":"ا ب ت"},"businessName":{"en":"Sirdab Lab","ar":"ا ب ت"}}]},{"product":"tap","title":{"en":"Our Community","ar":"مجتمعنا"},"testimonials":[{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/bilbayt.jpg","qoute":{"en":"Tap has truly enabled Bilbayt.com to serve it’s customer base effectively while also delivering the excellent user experience and interface we were searching for.","ar":"ا ب ت"},"name":{"en":"Ahmad Salamah","ar":"ا ب ت"},"role":{"en":"Co-founder & CEO","ar":"ا ب ت"},"businessName":{"en":"Bilbayt.com","ar":"ا ب ت"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/nuqat.jpg","qoute":{"en":"Tap has untapped the potential of our website through a well streamlined payment process!","ar":"ا ب ت"},"name":{"en":"Hussa Al Humaidhi","ar":"ا ب ت"},"role":{"en":"Founding Member","ar":"ا ب ت"},"businessName":{"en":"Nuqat","ar":"ا ب ت"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/opensouq.jpg","qoute":{"en":"We at OpenSooq.com are very happy with Tap, it proved to be a very reliable payment partner for us and our users love it!","ar":"ا ب ت"},"name":{"en":"Anas Elayyan","ar":"ا ب ت"},"role":{"en":"Head of Business Development","ar":"ا ب ت"},"businessName":{"en":"OpenSooq.com","ar":"ا ب ت"}},{"testimonialImage":"https://www.tap.company//websiteImages/testimonials/sirdablab.jpg","qoute":{"en":"Tap made it easy for us to set up a payment portal and accept payments quickly. It’s a wonderful service for budding businesses.","ar":"ا ب ت"},"name":{"en":"Haider Al Mosawi","ar":"ا ب ت"},"role":{"en":"Learning & Laughter Officer","ar":"ا ب ت"},"businessName":{"en":"Sirdab Lab","ar":"ا ب ت"}}]}]
